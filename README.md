# HEALTH_DATABASE Project

> This project includes the creation of the database for the  Health database created basing on the schema diagram.

## Getting Started

This repository includes files with plain SQL that can be used to recreate a database:

- Check [schema_based_on_diagram.sql](./queries.sql) for examples of queries that can be run on a newly created database. **Important note: this file might include queries that make changes in the database (e.g., remove records). Use them responsibly!**
...
# 📖 [Health_database project] <a name="about-project"></a>

**[Health_database]** is a project that was was done to create a database for the Health_database.
** Schema diagram (ERD)** 
...
```sh
  cd my-folder
  git clone https://github.com/Victor-chiemerie/Health_Database.git
```
--->
